  ...
  return (
    <div className="relative z-20 flex gap-6">
      ...
      <div>
        ...
        >
          <a href="#research" className="flex items-center gap-2 rounded-lg bg-cyan-400 px-6 py-3 text-sm font-semibold text-black tracking-wide shadow-[0_0_25px_rgba(34,211,238,.5)] hover:scale-105 transition-transform">
            EXPLORE RESEARCH <ArrowRight size={16} />
          </a>

          <a href="/Ayush_Dhote_CV.pdf" download className="flex items-center gap-2 rounded-lg border border-white/15 px-6 py-3 text-sm font-semibold text-white tracking-wide hover:border-cyan-400 hover:text-cyan-400 transition-colors">
        ...
        <motion.button
          ...
          className="mt-16 flex items-center gap-2 text-gray-500 text-xs tracking-wider hover:text-cyan-400 transition-colors cursor-pointer"
        >
